...
function rps_game(player_selection, comp_selection) {
  if (player_selection === comp_selection) {
    console.log(
      `It's a tie. You chose ${player_selection}, computer chose ${comp_selection}.`
    );
    ...
    player_score += 1;
    console.log(
      `You win! You chose ${player_selection}, computer chose ${comp_selection}.`
    );
    console.log(`Player Score: ${player_score}  Computer Score ${comp_score}`);
  } else {
    comp_score += 1;
    console.log(
      `You lose. You chose ${player_selection}, computer chose ${comp_selection}.`
    );
    console.log(`Player Score: ${player_score}  Computer Score ${comp_score}`);
  }
}
